...
void doctor_view_history() {
    ...
    if (count == 0) printf("该患者暂无您接诊的病历记录。\n");
...
void doctor_menu() {
    while (1) {
        ...
        switch (choice) {
            case 1: doctor_view_queue();       break;
            case 2: doctor_see_patient();      break;
            case 3: doctor_fill_exam_result(); break;
            case 4: doctor_view_history();     break;
        }
    }
}